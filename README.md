...
The purpose here is rename the folder to looks like the Temple OS project.

## About this project

```
This is a lite version og Gramado OS. It has 3D demo in adam/ and a kernel in kernel/.
After the initialization you need to type 'demo00'
